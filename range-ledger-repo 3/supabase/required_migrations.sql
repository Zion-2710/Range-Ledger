-- =============================================================================
-- Range Ledger — just the 4 migrations for: multi-staff accounts + invite
-- codes, the Google sign-up trigger fix, and parental consent.
-- Safe to run as one pass — every statement uses IF NOT EXISTS / CREATE OR
-- REPLACE / DROP...IF EXISTS, so nothing errors even if run more than once.
-- =============================================================================
